...
function Register() {
    ...
    const createSchema = Yup.object().shape({
        ...
        fullName: Yup.string()
            .required("Không được để trống")
            .matches(regexFullName, {
                message: "Không được chứa ký tự đặc biệt và số",
                excludeEmptyString: true
            }),
        confirmPassword: Yup.string()
            .required("Không được để trống!")
            .oneOf([Yup.ref('password'), null], "Chưa đúng mật khẩu!")
    })
            ...
            <div className={cx('container')}>
                <Form className={cx('form')}>
                    <div className={cx('header_form')}>
                        <h1 className={cx("form_title")}>Tạo tài khoản</h1>
                        <span className={cx("form_sub_title")}>Đăng ký để bắt đầu</span>
                    </div>
                    ...
                    <div className={cx('wrapper')}>
                        <div className={cx('wrap_items')}>
                            ...
                            <ErrorMessage name={"fullName"} render={(message) => errorMessage(message)}/>
                        </div>
                        <div className={cx('wrap_items')}>
                            <div className={cx("container_input")}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <ErrorMessage name={"username"} render={(message) => errorMessage(message)}/>
                        </div>
                        <div className={cx('wrap_items')}>
                            <div className={cx("container_input")}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <div className={cx('wrap_items')}>
                            ...
                            <ErrorMessage name={"confirmPassword"} render={(message) => errorMessage(message)}/>
                        </div>
                    </div>
    ...
    function registerUser (value) {
        ...
        setIsLoading(true);
        axios.post("http://localhost:4000/auth/register", user).then(async (res) => {
