            ...
            >
                <div className={cx('container')}>
                    <Form className={cx('form')}>
                        ...
                        <Link to={'/register'} className={cx('text_sub')}>Bạn chưa có tài khoản đăng nhập?</Link>
                        <div className={cx('text')}>Or connect</div>
                        <div className={cx("container_social")}>
                            <form action="http://localhost:4000/auth/google" method="post">
                                <button type={'submit'} className={cx("btn_social")}>
